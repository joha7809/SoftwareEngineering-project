...
public class AssignDevelopersSteps {
    ...
    public void isTheProjectLeader(String userInitials) {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }

    @Given("{string} is unavailable")
    ...
    @Then("{string} status is unchanged")
    public void statusIsUnchanged(String userInitials) {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }
    ...
    @When("project leader assigns {string} to activity")
    public void project_leader_assigns_to_activity(String userInitals) {
        // Write code here that turns the phrase above into concrete actions
    }
